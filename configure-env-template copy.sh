...
export ENVIRONMENT_TO_CONFIGURE="AWS"                          # GCP | AWS | BOTH 
...
export GCP_VELERO_ROLE_NAME="velero.server.role"
...
export AWS_VELERO_POLICY_NAME="velero"
export AWS_BUCKET="pvc-valero-aws-bucket" #Change the bucket name based on the naming convention and policies 